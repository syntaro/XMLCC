...
public class CCMIDICode {
    ...
    public static CCWrapDataList<Integer> listForGates() {
        CCWrapDataList<Integer> newList = new CCWrapDataList<>();
        for(int i = 0; i < 128; ++ i) {
    ...
    public static CCWrapDataList<Integer> listForProgramNumber() {
    ...
    public static CCWrapDataList<Integer> listForVelocity() {
        CCWrapDataList<Integer> list = new CCWrapDataList<Integer>();
        for (int i = 0; i <= 127; ++i) {
    ...
    public static CCWrapDataList<Boolean> listForSendOrDont() {
        CCWrapDataList<Boolean> list = new CCWrapDataList<Boolean>();
        list.addNameAndValue("Send", Boolean.TRUE);
        list.addNameAndValue("Don't send", Boolean.FALSE);
        return list;
    }

    public static CCWrapDataList<Integer> listForMSB() {
        CCWrapDataList<Integer> newList = new CCWrapDataList<>();
        for (int i = 0; i < 256; ++i) {
            String name = CCUtilities.toHexFF(i);
            Integer number = i;
    ...
    public static CCWrapDataList<Integer> listForLSB() {
        return listForMSB();
    }

    public static CCWrapDataList<Integer> listForCommands() {
        CCWrapDataList<Integer> list = new CCWrapDataList<>();
    ...
    public static CCWrapDataList<Integer> listForSystemModeCommands() {
        CCWrapDataList<Integer> list = new CCWrapDataList<>();
    ...
    public static CCWrapDataList<Integer> listForChannels(boolean withOmni) {
        CCWrapDataList<Integer> list = new CCWrapDataList();
        if (withOmni) {
    ...
    public static CCWrapDataList<Integer> listForChannelModeMessage() {
        CCWrapDataList<Integer> list = new CCWrapDataList<>();
    ...
    public static CCWrapDataList<Integer> listForPercent() {
        CCWrapDataList<Integer> list = new CCWrapDataList();
    ...
    public static CCWrapDataList<Integer> listForControlChange() {
        CCWrapDataList<Integer> list = new CCWrapDataList<>();
        for (int i = 0; i <= 119; ++i) {
            String name = nameOfControlChange(i);
            list.addNameAndValue(name + "(" + i + ")", i);
    ...
    public static CCWrapDataList<Integer> listForNoteNumber() {
        CCWrapDataList<Integer> list = new CCWrapDataList();
        for (int i = 0; i <= 127; ++i) {
    ...
    public static CCWrapDataList<Integer> lsitForDummy() {
        CCWrapDataList<Integer> list = new CCWrapDataList<Integer>();
