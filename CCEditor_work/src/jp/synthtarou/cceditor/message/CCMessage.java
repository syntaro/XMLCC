...
import jp.synthtarou.cceditor.midi.driver.CCDriver;
...
public class CCMessage {
    ...
    private void sendMessage(CCDriver driver, int device, byte[] buffer, int beginIndex, int endIndex) {
        ...
        System.out.println("Skip " + CCUtilities.dumpHexFF(trimBytes(_data, beginIndex, endIndex)));
    }
    
    public void sendBuffer(CCDriver driver, int device) {
        ...
        while(beginIndex < data.length) {
            ...
            switch(status) {
                ...
                default:
                    System.out.println("SkipByte " + CCUtilities.toHexFF(data[beginIndex]));
                    beginIndex ++;
                    break;
            }
        }
