...
public class CCLineReader {
    ...
    public CCLineReader(InputStream in) {
        this(in, "utf-8");
    }
    public CCLineReader(InputStream in, String charset) {
        _in = in;
        _charset = charset;
    ...
    protected boolean fetchInternal() throws IOException {
        if (_pos >= _bufferSize) {
    ...
    public String readLine() throws IOException {
        ...
        do {
            if (_pos >= _bufferSize && fetchInternal() == false) {
                break;
            }
