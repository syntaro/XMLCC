...
public class CCV12CategoryListPicker<T> extends javax.swing.JPanel implements IPrompt<T> {
    ...
    public static void main(String[] args) {
        CCWrapDataList<CCWrapDataList<String>> model = new CCWrapDataList<>();
    ...
    CCWrapDataList<CCWrapDataList<T>> _listCategory;
    CCWrapDataList<T> _listChoise;
     ...
     */
    public CCV12CategoryListPicker(CCWrapDataList<CCWrapDataList<T>> category, int selectedCategory, int selectedIndex) {
        initComponents();
