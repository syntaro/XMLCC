...
import static jp.synthtarou.cceditor.midi.smf.SMFMessage.dumpHexFF;
...
public class SMFParser {
    ...
    protected boolean parseFile(File file) throws IOException {
        ...
        try {
            ...
            BinaryInputStream reader = new BinaryInputStream(stream);
            ...
            try {
                ...
                for (int tr = 0; tr < tracks; tr++) {
                    ...
                    try {
                        BinaryInputStreamPart child = new BinaryInputStreamPart(reader, trackLength);
