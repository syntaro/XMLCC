...
import jp.synthtarou.cceditor.message.CCException;
...
public class SMFMessage implements Comparable<SMFMessage> {
    ...
    public CCMessage fromSMFtoMX() {
        CCMessage message = null;
        int port = 0;

        if (_status>= 0x80 && _status <= 0xef) {
            message = new CCMessage(_status, _data1, _data2);
        }
        else if (_status == 0xf0 || _status == 0xf7) {
            //SYSEX
            message = new CCMessage(getBinary());
        }
    ...
    public int compareTo(SMFMessage o) {
        ...
        boolean isProg1 = (o1._status & 0xf0) == CCMIDICode.COMMAND_PROGRAMCHANGE;
        boolean isProg2 = (o2._status & 0xf0) == CCMIDICode.COMMAND_PROGRAMCHANGE;
        boolean isBank1 = (o1._status & 0xf0) == CCMIDICode.COMMAND_CONTROLCHANGE && (o1._data1 == 0 || o1._data1 == 32);
        boolean isBank2 = (o2._status & 0xf0) == CCMIDICode.COMMAND_CONTROLCHANGE && (o2._data1 == 0 || o2._data1 == 32);
    ...
    public int toDwordMessage() throws CCException {
        if (isBinaryMessage()) {
            throw new CCException("Its binary");
        }
        int st = _status & 0xff;
        int dt1 = _data1 & 0xff;
        int dt2 = _data2 & 0xff;
